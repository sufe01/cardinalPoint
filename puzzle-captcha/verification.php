...
$background_color = imagecolorallocate($captcha_image, 100, 0, 0);
// sets some colors
$white = imagecolorallocate($captcha_image, 255, 255, 255);
$grey = imagecolorallocate($captcha_image, 128, 128, 128);
$black = imagecolorallocate($captcha_image, 0, 0, 0);
imagefilledrectangle($captcha_image, 0, 0, 399, 229, $white);
