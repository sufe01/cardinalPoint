...
(function ($) {
    ...
    var imJs = {
        ...
        stickyHeader: function (e) {
          $(window).scroll(function () {
              if ($(this).scrollTop() > 150) {
                  ...
                  $('#index-logo').attr('src', 'assets/images/logo.png');
              } else {
                $('.header--sticky').removeClass('sticky')
                $('#index-logo').attr('src', 'assets/images/full-white.png');
              }
          })
        },
        // done
        ...
        DarkLightActive:function(){
          const footerLogoImg = document.querySelector('.footer-one-left .logo img');
          var retrieveDarkLightMode = localStorage.getItem('rtstheme');
          if (retrieveDarkLightMode === 'light') {
            footerLogoImg.src = 'assets/images/logo.png';
          } else if (retrieveDarkLightMode === 'dark') {
            footerLogoImg.src = 'assets/images/full-white.png';
          }else{
            footerLogoImg.src = 'assets/images/logo.png';
          }
        ...
        DarkLightActive2:function(){
          ...
          if (rts_go_dark.length) {
            let rtstheme = localStorage.getItem('rtstheme');
            const godarkrts = document.querySelector('.rts-go-dark2')
            const golightrts = document.querySelector('.rts-go-light2')    
